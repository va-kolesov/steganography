...
const Encrypt = () => {
 ...
 return ( 
    <body class="img3" >
      ...
      <button onClick={goHome} class="nazad">Назад</button>
      
      
      
    <form onSubmit={e => e.preventDefault()} action="" >
      <textarea name="Text1" cols="40" rows="5" value={value} onChange={handleChange} class="field-type"></textarea>
    ...
    <Link to="/resultencrypt"><button disabled={!value|| !image} className="primenit">Применить</button> </Link>
    </form>
    </body>
  );
};
